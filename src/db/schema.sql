...
CREATE TABLE IF NOT EXISTS users (
  ...
  afk_after_minutes INT NOT NULL DEFAULT 10,
  offline_after_minutes INT NOT NULL DEFAULT 30,
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS afk_enabled BOOLEAN NOT NULL DEFAULT true;
ALTER TABLE users ADD COLUMN IF NOT EXISTS afk_after_minutes INT NOT NULL DEFAULT 10;
ALTER TABLE users ADD COLUMN IF NOT EXISTS offline_after_minutes INT NOT NULL DEFAULT 30;
DO $$
BEGIN
